          ...
          <form action="">
            <div className="w-full lg:w-2/3 lg:mx-auto">
              <div className="w-full px-4 mb-8">
                ...
                <input type="text" id="name" className="w-full bg-slate-200 text-slate-800 p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" />
              </div>
              <div className="w-full px-4 mb-8">
                <label htmlFor="email" className="text-base text-primary font-bold">Email</label>
                <input type="text" id="email" className="w-full bg-slate-200 text-slate-800 p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary" />
              </div>
              <div className="w-full px-4 mb-8">
                <label htmlFor="message" className="text-base text-primary font-bold">Pesan</label>
                <textarea type="text" id="message" className="w-full bg-slate-200 text-slate-800 p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32">
                </textarea>
              </div>
              <div className="w-full px-4 mb-8">
        ...
        <div className="container">
          ...
          <div className="w-full pt-10 border-t border-slate-600">
            <div className="flex items-center justify-center mb-5">
              ...
              {/* Instagram */}
              <Link to="https://instagram.com/nadazkia" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-500 text-slate-500 hover:border-primary hover:bg-primary hover:text-white">
              ...
              {/* linked.in */}
              <Link to="https://www.linkedin.com/in/nadazkia18/" className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-500 text-slate-500 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <p className="font-medium text-xs text-slate-500 text-center">Dibuat dengan ❤ oleh <Link to="https://instagram.com/nadazkia" className=" font-bold hover:opacity-90 text-primary"> Nada Fatiyyah Azkia </Link>  menggunakan <Link to="https://tailwindcss.com" className=" font-bold hover:opacity-90 text-sky-500"> Tailwind CSS</Link> dan <Link to="https://react.dev" className=" font-bold hover:opacity-90 text-sky-500">ReactJS</Link></p>
          </div>
          {/* Copyright */}
        </div>
      </footer>
