        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              <NavLink to="/contact">
              <button className="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out"> Hubungi Saya</button>
              </NavLink>
            </div>
            <div className="w-full self-end px-4 lg:w-1/2">
              <div className="relative mt-10 lg:mt-0 lg:right-0">
                <img src="img/profile.png" alt="Nada Fatiyah Azkia" className="max-2-full mx-auto" />
        ...
        <div className="container">
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2 md:pt-3">
              ...
              <p className="font-medium text-base text-pudar mb-6 lg:text-lg">Berikut akun media sosial saya</p>
